...
data = {
    'Soil_Quality': [80, 70, 75, 85, 90],
    'Seed_Variety': [1, 0, 1, 0, 1],
    'Fertilizer_Amount': [100, 80, 120, 110, 105],
    'Sunny_Days': [100, 90, 120, 80, 95],
    'Rainfall': [500, 400, 600, 550, 450],
    'Irrigation_Schedule': [3, 2, 4, 3, 5],
    'Yield_kg_per_hectare': [3000, 2500, 3500, 3200, 3300]
}
...
def app():
    ...
    if st.button('Predict'):
        ...
        X_test = [[soil_quality, seed_variety, fertilizer_amount, sunny_days, rainfall, irrigation_schedule]]
        y_pred_test = model.predict(X_test)
        st.write(f'Model prediction for given input: {y_pred_test[0]:.2f}')
